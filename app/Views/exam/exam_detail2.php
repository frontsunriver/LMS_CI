            ...
            <div id="main-right" class="col-md-9 ms-sm-auto col-lg-10">
              ...
              <section class="px-md-4 bg-light">
                   ...
                   <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="<?php echo base_url('/exam/'); ?>">LMS</a></li>
                        ...
                        <div class="text-left shadow">
                            <div class="card-style card">
                              <div class="card-header">
                                <div class="name p-1" style="display: inline-block;">Exámenes: <?= $nombre_salon." - ".$nombre_curso; ?></div>
                                <button type="button" class=" btn float-end py-1 px-2 btn-success me-2"><b><a style="color: white;text-decoration: none;" href="<?= base_url('calendario/mes/'.$curso['nemo'].'/'.$curso['cod']); ?>">create new exam</a></b></button>
